...
public interface MixingProxy extends Remote {
    ...
    byte[] sendCapsule(LocalDateTime startTime, LocalDateTime endTime, String token, byte[] signature, byte[] encodedLine, PublicKey publicKey) throws RemoteException;
